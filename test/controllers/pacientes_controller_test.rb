...
class PacientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post pacientes_url, params: { paciente: { cidade_id: @paciente.cidade_id, endereco: @paciente.endereco, idade: @paciente.idade, latitude: @paciente.latitude, longitude: @paciente.longitude, nome: @paciente.nome, nome_mae: @paciente.nome_mae, ocupacao_id: @paciente.ocupacao_id, peso: @paciente.peso, sexo: @paciente.sexo, telefone: @paciente.telefone } }
    end
  ...
  test "should update paciente" do
    patch paciente_url(@paciente), params: { paciente: { cidade_id: @paciente.cidade_id, endereco: @paciente.endereco, idade: @paciente.idade, latitude: @paciente.latitude, longitude: @paciente.longitude, nome: @paciente.nome, nome_mae: @paciente.nome_mae, ocupacao_id: @paciente.ocupacao_id, peso: @paciente.peso, sexo: @paciente.sexo, telefone: @paciente.telefone } }
