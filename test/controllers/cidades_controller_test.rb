...
class CidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cidade" do
    assert_difference('Cidade.count') do
      post cidades_url, params: { cidade: { latitude: @cidade.latitude, longitude: @cidade.longitude, nome: @cidade.nome, uf: @cidade.uf } }
    end
  ...
  test "should update cidade" do
    patch cidade_url(@cidade), params: { cidade: { latitude: @cidade.latitude, longitude: @cidade.longitude, nome: @cidade.nome, uf: @cidade.uf } }
